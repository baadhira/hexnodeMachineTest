...
import singleApp from "../assets/images/single-app-kiosk.png";
import multiApp from "../assets/images/multi-app-kiosk.png";
import webBased from "../assets/images/web-based-kiosk.png";
import digitalSign from "../assets/images/digital-signages.png";
import asam from "../assets/images/asam-kiosk.png";
                ...
                <div
                  style={{
                    animation: slideDirection
                      ? `${slideDirection} 0.3s ease-out`
                      : "none",
                  }}
                  key={key} 
                  className={`animated-content ${slideDirection}`}
                >
                  <div className="contentWrapper">
                    <div className="text-content">
                      ...
                      <ul className="features-list">
                        {tabsData[selectedTab].features.map(
                          (feature, index) => (
